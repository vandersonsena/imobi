...
const debug = require('debug')('protocol:afc');
...
(function (AFC_OPS) {
    ...
    AFC_OPS[AFC_OPS["FILE_WRITE_OFFSET"] = 40] = "FILE_WRITE_OFFSET"; /* FileRefWriteWithOffset */
...
(function (AFC_FILE_OPEN_FLAGS) {
    ...
    AFC_FILE_OPEN_FLAGS[AFC_FILE_OPEN_FLAGS["RDAPPEND"] = 6] = "RDAPPEND"; // a+  O_RDWR   | O_APPEND | O_CREAT
...
class AFCProtocolClient extends protocol_1.ProtocolClient {
    ...
    sendMessage(msg) {
        return new Promise((resolve, reject) => {
            ...
            this.writer.write(this.socket, Object.assign({}, msg, { requestId }));
        });
    }
}
...
class AFCProtocolReader extends protocol_1.ProtocolReader {
    ...
    parseHeader(data) {
        let magic = data.slice(0, 8).toString('ascii');
