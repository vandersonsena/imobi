...
const debug = require('debug')('protocol:usbmux');
...
class UsbmuxProtocolWriter {
    ...
    write(socket, msg) {
        ...
        const plistMessage = plist.build(Object.assign({ "BundleID": "io.ionic.native-run", "ClientVersionString": "usbmux.js", "MessageType": messageType, "ProgName": "native-run", "kLibUSBMuxVersion": 3 }, extraFields));
