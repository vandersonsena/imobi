...
const debug = require('debug')('client:installation_proxy');
...
class InstallationProxyClient extends client_1.ServiceClient {
    ...
    async lookupApp(bundleIds, options = {
        ...
        const resp = await this.protocolClient.sendMessage({
            "Command": "Lookup",
            "ClientOptions": Object.assign({ "BundleIDs": bundleIds }, options)
        });
    ...
    async installApp(packagePath, bundleId, options = {
        ...
        return this.protocolClient.sendMessage({
            ...
            "ClientOptions": Object.assign({ "CFBundleIdentifier": bundleId }, options),
        }, (resp, resolve, reject) => {
